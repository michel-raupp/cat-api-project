...
import { Hero, SliderContainer } from './styles/styles';
import { fetchCatBreeds } from './data';
import BreedInfo from './components/cat-info';
import SkillBar, { SkillBarWrapper } from './components/skills';
import DropdownSelector from './components/buttons';
